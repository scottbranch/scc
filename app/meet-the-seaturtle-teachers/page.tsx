        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="font-zen-maru-gothic text-lg lg:text-xl text-gray-700 leading-relaxed text-balance">
              ...
              Get ready for a wonderful year and fantastic SCC experience. We
              are absolutely thrilled and beyond blessed these ladies will be
              teaching and caring for your children this year.{' '}
            </p>
            <p className="font-zen-maru-gothic text-lg lg:text-xl text-gray-700 leading-relaxed text-balance mt-4">
              ...
              STEM, art, music and learning to this 3-4 year old program. They
              are Rockstar teachers, and will lead your 3-4 year old's through
              their year of exploration, learning, pre-reading and pre-writing
              skills, and challenges these students each day with new science,
              art, math and dramatic play opportunities.
              <p className="font-zen-maru-gothic text-lg lg:text-xl text-gray-700 leading-relaxed text-balance mt-4">
                This incredible team will take their students on an adventure
                this year that will offer foundational learning and play
                opportunities while getting them emotionally, socially,
                academically and spiritually ready for their Pre-K experience
                next year.
              </p>
            </p>
          </div>
