        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-ovo uppercase text-4xl lg:text-6xl font-normal text-black leading-tight text-balance mb-8">
              Meet our Surfer Teachers
            </h1>
            <p className="font-zen-maru-gothic text-lg lg:text-xl text-gray-700 leading-relaxed text-balance">
              We are very excited to have you join our Pre-K Surfer Program this
              year! These amazing women come with a wealth of teaching talents
              and passion for this age group. These ladies are gifted teachers
              who love children and are dedicated to preparing youngsters for a
              successful Kindergarten experience the following year. Their goal
              is to guide children to become confident, compassionate, loving,
              respectful and self-motivated learners. This talented team will
              lead your child through a magical year of learning, where they
              will develop life-long friendships, personal responsibility,
              reading and writing skills, and so much more!
            </p>
          </div>
        </section>
