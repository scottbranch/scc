            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="font-zen-maru-gothic text-base leading-relaxed text-gray-700">
                  ...
                  supports California Common Core standards. SCC students LOVE
                  outside play, sports programs, and various exercise
                  opportunities. We strive to offer outside learning
                  opportunities as often as possible, with outside classrooms,
                  STEAM areas and Garden Boxes (coming soon)!
                </p>
              </div>
            </div>
          </div>
