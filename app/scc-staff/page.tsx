      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="py-16 lg:py-24">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="font-zen-maru-gothic text-lg lg:text-xl text-gray-700 leading-relaxed text-balance">
                At Surf City Christian Child Development Preschool, our teachers
                and staff are the heart of our school. Each educator brings
                unique gifts, experience, and a deep love for children, creating
                a nurturing, faith-filled environment where every child feels
                known, valued, and encouraged to grow.
              </p>
            </div>
          </section>
        </AnimatedSection>
          ...
          <section className="py-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-ovo text-3xl lg:text-4xl font-normal text-black mb-6 text-center">
                Guppies Program – Toddlers (18–36 Months)
              </h2>
        ...
        <AnimatedSection animation="fadeInUp">
          <section className="py-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-ovo text-3xl lg:text-4xl font-normal text-black mb-6 text-center">
                Starfish Program – Young Preschool
              </h2>
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/cassie.jpg"
                        alt="Ms. Cassie"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Cassie has nearly 20 years at SCC and is known for
                        her intentional relationships and thoughtful classroom
                        practices.
                      </p>
                    </div>
                  </div>
        ...
        <AnimatedSection animation="fadeInUp">
          <section className="py-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-ovo text-3xl lg:text-4xl font-normal text-black mb-6 text-center">
                Sea Turtles Program – Preschool (3–4 Years)
              </h2>
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Sophia creates a consistent, loving, and inviting
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Ruby brings joy and fluent Spanish into the
                        classroom in a natural and engaging way.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/annie.jpg"
                        alt="Ms. Annie"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Annie has over 20 years of experience and is known
                        for her joyful spirit and strong student relationships.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/aleah.jpg"
                        alt="Ms. Aleah"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
        ...
        <AnimatedSection animation="fadeInUp">
          <section className="py-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-ovo text-3xl lg:text-4xl font-normal text-black mb-6 text-center">
                Surfers Program – Transitional Kindergarten (TK)
              </h2>
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/stacey.jpg"
                        alt="Ms. Stacy"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/maddie.jpg"
                        alt="Ms. Maddie"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Maddie gently builds confidence in each student
                        through her consistent, loving approach.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Cali brings joy, warmth, and encouragement to her
                        classroom.
                      </p>
                    </div>
                  </div>
        ...
        <AnimatedSection animation="fadeInUp">
          <section className="py-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-ovo text-3xl lg:text-4xl font-normal text-black mb-6 text-center">
                Sailors Program – TK / Kindergarten
              </h2>
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Julie is a seasoned educator with over 15 years of
                        experience, including elementary teaching.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Kaili is a proud SCC alumni who returned to bless
                        the next generation with love and joy.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/kristine.jpg"
                        alt="Ms. Kristin"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Kristin specializes in parent and child connections,
                        ensuring families feel supported.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex flex-col sm:flex-row gap-6 items-start">
                    <div className="flex-shrink-0">
                      <Image
                        src="/images/headshots/sarah-office.jpg"
                        alt="Ms. Sara"
                        width={150}
                        height={150}
                        className="rounded-lg object-cover"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-zen-maru-gothic text-gray-700 leading-relaxed">
                        Ms. Sara provides excellent office management with
